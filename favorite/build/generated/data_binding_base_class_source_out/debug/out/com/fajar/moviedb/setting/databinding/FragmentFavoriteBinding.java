...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  private FragmentFavoriteBinding(@NonNull ConstraintLayout rootView, @NonNull TabLayout tabs,
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoriteBinding((ConstraintLayout) rootView, tabs, viewPager);
    }
