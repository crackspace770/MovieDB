...
public final class FragmentTvBinding implements ViewBinding {
  ...
  private FragmentTvBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progressBar,
  ...
  public static FragmentTvBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTvBinding((ConstraintLayout) rootView, progressBar, rvMovie,
