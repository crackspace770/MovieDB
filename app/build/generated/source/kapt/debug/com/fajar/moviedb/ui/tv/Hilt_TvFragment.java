 ...
 */
public abstract class Hilt_TvFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TvFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TvFragment_GeneratedInjector) this.generatedComponent()).injectTvFragment(UnsafeCasts.<TvFragment>unsafeCast(this));
    }
  }
